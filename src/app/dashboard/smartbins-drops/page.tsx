...
export default function SmartbinDropsDataTablePage() {
  const { data: smartbinsDrops, error, isFetched } = useGetSmartbinsDrops();
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Smartbin Drops Table</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm py-12">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h3 className="text-lg font-semibold tracking-tight text-muted-foreground">Loading smartbin drops...</h3>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-destructive shadow-sm py-12">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h3 className="text-lg font-semibold tracking-tight text-destructive">Error loading smartbin drops</h3>
