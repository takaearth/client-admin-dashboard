...
export default function PickupsDataTablePage() {
  const { pickups, loading, error } = useFirebasePickups();
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Pickups Table</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm py-12">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h3 className="text-lg font-semibold tracking-tight text-muted-foreground">Loading pickups...</h3>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-destructive shadow-sm py-12">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <h3 className="text-lg font-semibold tracking-tight text-destructive">Error loading pickups</h3>
